    ...
    (resolve, reject) => {
      ...
      .then(validatedUser => {
        if (validatedUser.exists) {
          ...
          const created_by = (!validatedUser.details.created.by || validatedUser.details.created.by === undefined || validatedUser.details.created.by === '') ? uuid : validatedUser.details.created.by;
          const lastmodified_by = (!validatedUser.details.lastModified.by || validatedUser.details.lastModified.by === undefined || validatedUser.details.lastModified.by === '') ? uuid : validatedUser.details.lastModified.by;
          ...
          var profileToSave = new Profile({
            ...
            email: validatedUser.details.username,
