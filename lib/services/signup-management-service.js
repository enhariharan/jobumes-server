  ...
  return new Promise(
    ...
    var newUserDTO = {};
      ...
      .then(savedUser => {
        ...
        var userdetails = newUserDetails.detailsinjson;

          if (!newUserDetails.middleName || newUserDetails.middleName === undefined || newUserDetails.middleName === '')
            newUserDetails.middleName = ' ';
          else
            newUserDetails.middleName = newUserDetails.middleName;
