...
exports.getOrganizationsByProfile = (profile) => {
  return new Promise(
    (resolve, reject) => {
      var orgDTO = [];
      Organization.find({"admin":profile.uuid},{"uuid":1,"name":1,"admin":1,"status":1,"description":1,"address":1,"internet":1,
    "email":1,"phone":1,"socialProfile":1,"logo.fileName":1,"logo.type":1,"logo.uri":1})
       .then(orgs => {
         var profileDTO ={};
...
exports.updateOrganizations = (profileUuid,orgDetails) => {
  ...
  return new Promise(
    (resolve, reject) => {
      ...
      var address = {
        line1 : orgDetails.line1,
        line2 : orgDetails.line2,
        city : orgDetails.city,
        state : orgDetails.state,
        country : orgDetails.country,
        zip : orgDetails.zip,
        googleMapsUri : orgDetails.googleMapsUri
      };
      var phone = [];
      var phoneObj = {};
...
exports.checkOrganizationExists = (orgName) => {
  ...
  return new Promise(
    (resolve, reject) => {
      ...
      .then(org => {
        if(!org || org === undefined) { resolve(org); }
