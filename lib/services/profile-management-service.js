...
var changePassword = (modifiedBy,cp) => {
  ...
  return new Promise(
    ...
    "login.username":1,"login.password":1,"firstName":1,"middleName":1,"lastName":1,"email":1,"phoneNumber":1,"gender":1,"socialProfiles":1};
...
var changePassword = (modifiedBy,changeProfile) => {
  "use strict";
...
module.exports = {getProfileByUuid, getProfileByUser, getProfileByUsername, getProfileByAuthCredentials,
  ...
  saveJobs, getSavedJobs, checkProfileExists};
