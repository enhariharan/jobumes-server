...
var _getEmployerDetails = (profileUuid) => {
  return new Promise(
    (resolve, reject) => {
      ...
      .then(empDetails => {
        const org = (!empDetails.organization || empDetails.organization === undefined || empDetails.organization === '') ? 'undefined' : empDetails.organization;
        orgManagementService.getOrgDetailsByUuid(org)
        .then(orgDetails => {
          var employer = {};
