...
var _getEmployerDetails = (profileUuid) => {
  return new Promise(
    (resolve, reject) => {
      ...
      .then(empDetails => {
        console.log('empDetails :: %j',empDetails);
        var org = "";
        const orgUuid = (!empDetails.organization || empDetails.organization === undefined || empDetails.organization === '') ? org : empDetails.organization;
        console.log('orgUuid:: '+empDetails.organization);
        if(!empDetails.organization || empDetails.organization === undefined || empDetails.organization === ''){
          var employer = {};
