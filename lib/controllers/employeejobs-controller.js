...
var EmployeeManagementService = require('../services/feedback-management-service');
...
exports.addFeedback = function (req, res) {
  ...
  .then(result =>{ return EmployeeManagementService.addFeedback(credentials, feedback); })
  .then(savedFeedback => {
